...
__turbopack_context__.s({
    ...
    "DEFAULT_OVERRIDEABLE_FIELDS": (()=>DEFAULT_OVERRIDEABLE_FIELDS),
    "OWN_PROPS_NAME": (()=>OWN_PROPS_NAME),
...
const DEFAULT_OVERRIDEABLE_FIELDS = [
    ...
    "initialValue",
    "deprecated"
], OWN_PROPS_NAME = "_internal_ownProps", DEFAULT_MAX_FIELD_DEPTH = 5, stringFieldsSymbols = {}, getStringFieldSymbol = (maxDepth)=>(stringFieldsSymbols[maxDepth] || (stringFieldsSymbols[maxDepth] = Symbol(`__cachedStringFields_${maxDepth}`)), stringFieldsSymbols[maxDepth]), isReference = (type)=>type.type && type.type.name === "reference", portableTextFields = [
    "style",
    "list"
...
__turbopack_context__.s({
    ...
    "processSchemaSynchronization": (()=>processSchemaSynchronization),
    "validateMediaLibraryAssetAspect": (()=>validateMediaLibraryAssetAspect),
    "validateSchema": (()=>validateSchema)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$descriptors$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@sanity/descriptors/dist/index.js [app-client] (ecmascript)");
...
class DescriptorConverter {
   ...
   */ get(schema) {
        ...
        const builder = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$descriptors$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SetBuilder"]();
        for (const name of schema.getLocalTypeNames()){
            const typeDef = convertTypeDef(schema.get(name));
            builder.addObject("sanity.schema.namedType", {
                name,
                typeDef
            });
        }
...
function convertCommonTypeDef(schemaType, opts) {
    const ownProps = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"] in schemaType ? schemaType[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"]] : schemaType;
    let fields;
    Array.isArray(ownProps.fields) && (fields = ownProps.fields.map(({ name, group, fieldset, type })=>({
            name,
    ...
    let groups;
    Array.isArray(ownProps.groups) && (groups = filterStringKey("name", ownProps.groups.map(({ name, title, hidden, default: def })=>({
            name,
            title: maybeString(title),
            hidden: conditionalTrue(hidden),
...
function processSchemaSynchronization(sync, response) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$descriptors$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["processSetSynchronization"])(sync, response);
}
...
const OVERRIDABLE_FIELDS$f = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_OVERRIDEABLE_FIELDS"]
], ANY_CORE = {
    name: "any",
    type: null,
    jsonType: "any"
    ...
    extend (subTypeDef, extendMember) {
        ...
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(ANY_CORE, OVERRIDABLE_FIELDS$f), ownProps, {
            type: ANY_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$f), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
            };
        }
    }
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "of", ()=>subTypeDef.of.map((ofTypeDef)=>createMemberType(ofTypeDef))), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...subTypeDef,
                of: parsed.of
            }), {
            enumerable: !1,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    if (extensionDef.of) throw new Error('Cannot override `of` property of subtypes of "array"');
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$e), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
            };
        }
    }
...
const DEFAULT_LINK_ANNOTATION = {
    ...
    extend (subTypeDef, extendMember) {
        const options = {
            ...
            ...rest,
            options
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(BLOCK_CORE, INHERITED_FIELDS$1), ownProps, {
            type: BLOCK_CORE
        });
        return lazyGetter(parsed, "fields", ()=>fields.map((fieldDef)=>{
            ...
            })), lazyGetter(parsed, "preview", createPreviewGetter(subTypeDef)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...ownProps,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, INHERITED_FIELDS$1), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
...
const INHERITED_FIELDS = [
    ...
    extend (subTypeDef, extendMember) {
        const options = {
            ...
            ...subTypeDef,
            options
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(SPAN_CORE, INHERITED_FIELDS), ownProps, {
            type: SPAN_CORE
        });
        return lazyGetter(parsed, "fields", ()=>fields.map((fieldDef)=>{
                const { name, ...type } = fieldDef;
            ...
            })), lazyGetter(parsed, "annotations", ()=>annotations.map(extendMember)), lazyGetter(parsed, "marks", ()=>marks.map(extendMember)), lazyGetter(parsed, "preview", createPreviewGetter(subTypeDef)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...ownProps,
                fields: parsed.fields,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, INHERITED_FIELDS), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
...
const OVERRIDABLE_FIELDS$d = [
    ...
    extend (subTypeDef) {
        ...
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(BOOLEAN_CORE, OVERRIDABLE_FIELDS$d), ownProps, {
            type: BOOLEAN_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$d), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
...
const CrossDatasetReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS$2.map((fieldDef)=>{
                ...
                }))), lazyGetter(parsed, "title", ()=>subTypeDef.title || buildTitle$2(parsed)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...subTypeDef,
                fields: parsed.fields,
                to: parsed.to,
                title: parsed.title
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$c), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(DATE_CORE, OVERRIDABLE_FIELDS$b), ownProps, {
            type: DATE_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$b), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(DATETIME_CORE, OVERRIDABLE_FIELDS$a), ownProps, {
            type: DATETIME_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$a), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
...
const OVERRIDABLE_FIELDS$9 = [
    ...
    extend (rawSubTypeDef, createMemberType) {
        ...
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(this.get(), OVERRIDABLE_FIELDS$9), ownProps, {
            type: this.get()
        });
        return lazyGetter(parsed, "fieldsets", ()=>createFieldsets(subTypeDef, parsed.fields)), lazyGetter(parsed, "groups", ()=>createFieldsGroups(subTypeDef, parsed.fields)), lazyGetter(parsed, "preview", createPreviewGetter(subTypeDef)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...ownProps,
                preview: parsed.preview
            }), {
            enumerable: !1,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$9);
                    subOwnProps.title = extensionDef.title || subTypeDef.title || (subTypeDef.name ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$startCase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(subTypeDef.name) : "Object");
                    ...
                    return lazyGetter(current, "__experimental_search", ()=>parent.__experimental_search), hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
            };
        }
    }
...
lazyGetter(EMAIL_CORE, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
        ...EMAIL_CORE,
...
const EmailType = {
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(EMAIL_CORE, OVERRIDABLE_FIELDS$8), ownProps, {
            type: EMAIL_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$8), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
    ...
    extend (rawSubTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fieldsets", ()=>createFieldsets(subTypeDef, parsed.fields)), lazyGetter(parsed, "preview", createPreviewGetter(Object.assign({}, subTypeDef, {
            fields
        }))), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...subTypeDef,
                options,
                fields: parsed.fields,
                title: parsed.title,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$7), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
...
const GlobalDocumentReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS$1.map((fieldDef)=>{
                ...
                return {
                    ...
                    ...toType
                }))), lazyGetter(parsed, "title", ()=>subTypeDef.title || buildTitle$1(parsed)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...subTypeDef,
                fields: parsed.fields,
                to: parsed.to,
                title: parsed.title
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$6), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    ...
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$5), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(NUMBER_CORE, OVERRIDABLE_FIELDS$4), ownProps, {
            type: NUMBER_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$4), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
...
const ReferenceType = {
    ...
    extend (subTypeDef, createMemberType) {
        ...
        return lazyGetter(parsed, "fields", ()=>REFERENCE_FIELDS.map((fieldDef)=>{
            ...
            })), lazyGetter(parsed, "fieldsets", ()=>createFieldsets(subTypeDef, parsed.fields)), lazyGetter(parsed, "to", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arrify$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(subTypeDef.to).map((toType)=>createMemberType(toType))), lazyGetter(parsed, "title", ()=>subTypeDef.title || buildTitle(parsed)), lazyGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ()=>({
                ...subTypeDef,
                fields: parsed.fields,
                fieldsets: parsed.fieldsets,
                to: parsed.to,
        ...
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    if (extensionDef.of) throw new Error('Cannot override `of` of subtypes of "reference"');
                    const ownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$3), current = Object.assign({}, parent, ownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(STRING_CORE, OVERRIDABLE_FIELDS$2), ownProps, {
            type: STRING_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$2), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(TEXT_CORE, OVERRIDABLE_FIELDS$1), ownProps, {
            type: TEXT_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS$1), current = Object.assign({}, parent, subOwnProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnProps), subtype(current);
                }
    ...
    extend (subTypeDef) {
        const ownProps = {
            ...subTypeDef,
            preview: primitivePreview
        }, parsed = Object.assign((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(URL_CORE, OVERRIDABLE_FIELDS), ownProps, {
            type: URL_CORE
        });
        return hiddenGetter(parsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], ownProps), subtype(parsed);
        "TURBOPACK unreachable";
        function subtype(parent) {
            return {
                ...
                extend: (extensionDef)=>{
                    const subOwnownProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2f$pick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(extensionDef, OVERRIDABLE_FIELDS), current = Object.assign({}, parent, subOwnownProps, {
                        type: parent
                    });
                    return hiddenGetter(current, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$schema$2f$lib$2f$_chunks$2d$es$2f$resolve$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OWN_PROPS_NAME"], subOwnownProps), subtype(current);
                }
            };
        }
    }
